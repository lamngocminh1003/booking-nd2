  ...
  const PostCard = ({ post }: { post: Post }) => (
    <Card className="group hover:shadow-lg transition-all duration-300 border-gray-200 h-full flex flex-col">
      ...
      <CardContent className="pt-0 p-4">
        ...
        <Link to={`/medical-procedures/${post.slug}`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center p-6 bg-emerald-50 border-emerald-200 hover:shadow-lg transition-shadow">
                <Activity className="w-12 h-12 mx-auto mb-4 text-emerald-600" />
                <h4 className="text-lg font-semibold text-emerald-800 mb-2">
                  Phẫu thuật trong ngày
                </h4>
                <p className="text-emerald-600 text-sm">
                  Quy trình và thủ tục phẫu thuật
                </p>
              </Card>

              <Card className="text-center p-6 bg-blue-50 border-blue-200 hover:shadow-lg transition-shadow">
                <User className="w-12 h-12 mx-auto mb-4 text-blue-600" />
                <h4 className="text-lg font-semibold text-blue-800 mb-2">
                  Đội ngũ bác sĩ
                </h4>
                <p className="text-blue-600 text-sm">Danh sách chuyên gia</p>
              </Card>

              <Card className="text-center p-6 bg-purple-50 border-purple-200 hover:shadow-lg transition-shadow">
                <BookOpen className="w-12 h-12 mx-auto mb-4 text-purple-600" />
                <h4 className="text-lg font-semibold text-purple-800 mb-2">
                  Hướng dẫn chuẩn bị
                </h4>
                <p className="text-purple-600 text-sm">
                  Chuẩn bị trước khám bệnh
                </p>
              </Card>
            </div>
          </div>
